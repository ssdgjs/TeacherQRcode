...
- ✅ 自动数据清理（可配置保留天数）
- ✅ Docker 一键部署
- ✨ **现代化 UI 设计**：渐变动画、圆角卡片、流畅过渡效果
- ✨ **实时通知系统**：成功/错误/警告/信息提示
- ✨ **快捷键支持**：提高操作效率（见下文快捷键列表）
- ✨ **一键复制**：访问码和链接快速复制到剪贴板
- ✨ **骨架屏加载**：优化加载体验，减少等待焦虑
...
| `Ctrl/Cmd + K` | 清空内容框 |
| `Ctrl/Cmd + 1` | 切换到静态码模式 |
| `Ctrl/Cmd + 2` | 切换到活码作业模式 |
| `Ctrl/Cmd + 3` | 切换到听力作业模式 |
| `Shift + ?` | 显示/隐藏快捷键面板 |
| `Esc` | 关闭快捷键面板 |

> 💡 提示：按 `Shift + ?` 可以随时查看快捷键帮助面板！
...
**色彩方案**
- 主色调：Teal（青绿色）系
- 渐变循环：`#0d9488` → `#14b8a6` → `#0f766e` → `#115e59`
- 语义色：Success（绿）、Error（红）、Warning（黄）、Info（蓝）
